...
class ManageBadgePage extends React.Component {
...
ManageBadgePage.propTypes = {
  class: PropTypes.object,
  actions: PropTypes.object.isRequired,
  history: PropTypes.object
};

ManageBadgePage.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps) (ManageBadgePage);
